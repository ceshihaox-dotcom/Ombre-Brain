...
2. **强制第三人称客观视角** (这是最重要的格式要求, 优先级凌驾其他规则):
   原文是对话格式 (用户 / AI 互相对话), 你重写时是"旁观者写故事", 不是延续对话.
   **必须做的人称转换** (按以下规则机械替换):
   - 原文用户说的"我..." → 改写成「用户...」或「Rin...」(用她名字)
   - 原文 AI 对用户说的"你..." → 改写成「用户...」或「Rin...」
   - 原文 AI 自指的"我..." → 改写成「AI...」或「克...」(用对应名字)
   - 原文用户问 AI 的"你..." → 改写成「AI...」或「克...」
   ✓ 正例: 「[[Rin]] 提到她最近忙搬家, [[克]] 回应说他理解她的疲惫」
   ✗ 反例: 「你最近忙搬家, 我说我理解你」 — 这是延续对话, 错
   ✗ 反例: 「我最近忙搬家, 他说他理解我」 — 视角混乱, 错
   **不要因为"读者就是用户"就用"你"亲近她** — 记忆 3 年后重读时
   "你/我"指代不清, 必须用名字/称谓
3. **提炼核心, 不是保留所有**:
